// ==UserScript==
// @name         AIDA TARIC Crawler 01-02 - Tabelle complete
// @namespace    fabry-aida-crawler
// @version      0.8.0
// @description  Estrae automaticamente i sottocapitoli 0101-0106 e 0201-0210 usando il comando reale di AIDA
...
(function () {
    ...
    const STATE_KEY = 'AIDA_V8_01_02_STATE';
    const DATA_KEY = 'AIDA_V8_01_02_DATA';
    const PANEL_ID = 'aida-v8-01-02-panel';
    ...
    function codesIn(text) {
        const matches =
            clean(text).match(/\b(?:01|02)(?:\s?\d{2}){0,4}\b/g) || [];
    ...
    function isSubchapterFormPage() {
        ...
        /*
         * Anche la schermata di selezione contiene tabelle HTML.
         * Perciò non possiamo escluderla usando isListPage().
         * Conta soltanto la presenza della casella visibile e modificabile.
         */
    ...
    function currentSubchapterFromPage() {
        ...
        if (/^(?:01|02)\d{2}$/.test(inputCode)) return inputCode;
    ...
    function nativeSubchapterControl(input) {
        ...
        /*
         * Il HAR mostra che il comando reale è:
         * <input name="B3" type="button" value="OK"
    ...
    function submitSubchapter(code) {
        ...
        /*
         * Usiamo il vero pulsante B3.
         * Il suo onclick esegue checkForm(this.form), che prepara
         * DataRiferimento, parametri e servlet corretti.
         */
        try {
            control.click();
            return true;
    ...
    function clickAidaBack() {
        ...
        /*
         * Alcune pagine di dettaglio o di errore non mostrano il
         * pulsante Indietro di AIDA. In quel caso usiamo la cronologia
         * soltanto come recupero, mai come navigazione ordinaria.
         */
        recordError(
    ...
    function recoverFromErrorPage() {
        ...
        /*
         * La pagina di errore di norma non contiene il pulsante AIDA.
         * Qui la cronologia è usata solo per tornare alla lista valida.
         */
        try {
            history.back();
        } catch (error) {
    ...
    function handleLoadedPage() {
        ...
        /*
         * Ricarichiamo sempre lo stato perché il controllo periodico
         * può partire dopo una navigazione effettuata da un altro documento.
         */
        ...
        if (state.nav === 'back-detail') {
            /*
             * Non aumentiamo l'indice finché siamo ancora nella pagina
             * di dettaglio. Se il primo click non ha reagito, ritentiamo.
             */
            if (isDetailPage()) {
                locked = true;
                setTimeout(() => {
    ...
    function start() {
        ...
        if (!isListPage()) {
            ...
            saveState();
            return alert(
                'Apri la tabella di 0101 oppure la schermata con il campo TARIC a 4 cifre e riprova.'
            );
        }
    ...
    function complete() {
        ...
        saveState();
        alert(`Test capitoli 01 e 02 completato fino a 0210. Dettagli: ${Object.keys(data.details).length}. Tabelle: ${Object.keys(data.tables).length}. Errori: ${state.errors.length}.`);
    }
    ...
    function downloadDetails() {
        ...
        download('AIDA_01_DETTAGLI.csv', rows);
    }
    ...
    function downloadTables() {
        ...
        download('AIDA_01_TABELLE_COMPLETE.csv', rows);
    }
    ...
    function createPanel() {
        ...
        title.textContent = 'AIDA CRAWLER 01+02 — V8.0';
        ...
        panel.append(title, status,
            button('AVVIA 0101 → 0210', start, '#fff', '#17466f'),
    ...
    /*
     * AIDA non genera sempre pageshow/load dopo i POST interni.
     * Questo controllo periodico sostituisce il click manuale su RIPRENDI.
     */
    setInterval(() => {
